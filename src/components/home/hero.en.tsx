          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl lg:text-2xl max-w-2xl leading-relaxed">
                Learn the world’s most effective self-defense system. Build
                confidence, strength, and skills that can save your life.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 py-8">
              ...
              <div className="text-center">
                ...
                <div className="text-sm">Affiliated Schools</div>
              </div>
              <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                ...
                <Link href="/federacao/instrutores">Free Trial Class</Link>
              </Button>
              <Button
                asChild
                size="lg"
                ...
                <Link href="/academias">Find a School</Link>
              </Button>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-6 pt-8 border-t border-gray-800">
              ...
              <div className="flex items-center gap-2 ">
                ...
                <span>Present Across Brazil</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative hidden lg:block">
            ...
            <div className="absolute -bottom-6 -right-2 bg-white text-black p-6 rounded-xl shadow-2xl max-w-xs">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-bold text-lg">Real Defense</div>
