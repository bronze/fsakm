    ...
    <div className="container mx-auto px-4 py-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {cards.map((card, index) => (
          <Card key={index} className="relative overflow-hidden h-80 group cursor-pointer">
            <div
            ...
            <CardContent className="relative z-10 h-full flex flex-col justify-between p-6 text-white">
              ...
              <Button
                className="bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-6 w-fit transition-all duration-300 group-hover:bg-red-700"
                size="lg">
                {card.buttonText}
