      ...
      <div
        ...
        <div
          ...
          <div className="ml-2.5 flex gap-4 sm:ml-0">
            ...
            <a
              className="text-muted-foreground"
              href="https://twitter.com/mikolajdobrucki">
        ...
        <div data-slot="footer-column" className="flex flex-col gap-4">
          <h3 className="text-md pt-1 font-semibold">Krav Maga</h3>
          <a href="#" className="text-muted-foreground text-sm">
            Criador
          </a>
          <a href="#" className="text-muted-foreground text-sm">
        ...
        <div data-slot="footer-column" className="flex flex-col gap-4">
          <h3 className="text-md pt-1 font-semibold">Federação</h3>
          <a href="#" className="text-muted-foreground text-sm">
        ...
        <div data-slot="footer-column" className="flex flex-col gap-4">
          <h3 className="text-md pt-1 font-semibold">Academias</h3>
          <a href="#" className="text-muted-foreground text-sm">
            Brasil
          </a>
          <a href="#" className="text-muted-foreground text-sm">
