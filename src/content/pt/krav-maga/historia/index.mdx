...
<Image
  src="/pt/images/krav-maga/historia/historia-mestrekobi.jpg"
  alt="Grão Mestre Kobi Lichtenstein"
  width={400}
  height={400}
  className="mx-auto my-8 mt-6 mb-4 h-auto w-sm max-w-1/2 text-center @lg:float-left @lg:mr-6"
/>

Em 1971, Imi entrega a primeira faixa preta a Eli Avigzar e realiza o primeiro curso de instrutores. Em 1978, funda a Associação de Krav Maga Israelense. Então, chega a década de 80 e Imi, com a preocupação de dar continuidade à sua obra, transmitindo-a para o resto do mundo e para as próximas gerações, decide selecionar um pequeno grupo que seria treinado e preparado para este fim, do qual o Mestre Kobi é parte integrante. Em 1987, foi liberado o ensino do Krav Maga fora de Israel.
...
<Image
  src="/pt/images/krav-maga/historia/kravmaga-histoira2.jpg"
  alt="Imi Lichtenfeld"
  width={600}
  height={300}
...
<Image
  src="/pt/images/krav-maga/historia/mkobi-galeria-2.jpg"
...
<Image
  src="/pt/images/krav-maga/historia/mkobi-galeria-3.jpg"
  alt="Imi e Mestre Kobi"
  width={600}
  height={300}
  className="mx-auto my-8 mb-4 h-auto w-full text-center"
